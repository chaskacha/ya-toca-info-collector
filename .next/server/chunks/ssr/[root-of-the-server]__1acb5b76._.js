...
function StationOne() {
    ...
    async function submit() {
        ...
        try {
            ...
            const res = await fetch('/api/cabildos/station-1', {
                method: 'POST',
                headers: {
            ...
            markStationDone(1);
            // 3) UX: show success and go back to menu
            setNotice('¡Gracias! Tu respuesta fue guardada.');
            setTimeout(()=>router.replace('/'), 900);
        } catch (e) {
            setNotice('No pudimos guardar tu respuesta. Intenta de nuevo.');
        } finally{
            setBusy(false);
        }
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1acb5b76._.js.map